...
// import { CalendarIcon, ChevronDown, ChevronRight, ChevronUp, Info, InfoIcon, Link2 } from 'lucide-react';
...
//                                             <PopoverTrigger asChild>
//                                                 <Button variant="outline" className="w-full justify-start text-left font-normal bg-gray-50">
//                                                     {endDate ? format(endDate, "PPP") : "Date To"}
//                                                     <CalendarIcon className="ml-auto h-4 w-4 opacity-50" />
//                                                 </Button>
//                                             </PopoverTrigger>
//                                             <PopoverContent className="w-auto p-0" align="start">
...
//                             <CollapsibleTrigger className="flex items-center justify-between w-full p-6">
//                                 <div className="flex items-center gap-2">
//                                     <h2 className="text-lg font-medium">Facebook Pixel and Google Analytics</h2>
//                                     <Info className="h-5 w-5 text-gray-400" />
//                                 </div>
//                                 {openSections.facebookPixel ? <ChevronUp className="h-5 w-5" /> : <ChevronDown className="h-5 w-5" />}
//                             </CollapsibleTrigger>
//                             <CollapsibleContent className="px-6 pb-6">
//                                 <div className="bg-gray-50 p-6 rounded-lg text-center">
//                                     <h3 className="text-lg font-medium mb-4">
//                                         Create account to enable your Facebook pixel and Google Analytics code.
//                                     </h3>
...
//                             <CollapsibleTrigger className="flex items-center justify-between w-full p-6">
//                                 <div className="flex items-center gap-2">
//                                     <h2 className="text-lg font-medium">Crawler Access</h2>
//                                     <Info className="h-5 w-5 text-gray-400" />
//                                 </div>
//                                 {openSections.crawlerAccess ? <ChevronUp className="h-5 w-5" /> : <ChevronDown className="h-5 w-5" />}
//                             </CollapsibleTrigger>
//                             <CollapsibleContent className="px-6 pb-6">
//                                 <div className="space-y-4">
...
//                             <CollapsibleTrigger className="flex items-center justify-between w-full p-6">
//                                 <div className="flex items-center gap-2">
//                                     <h2 className="text-lg font-medium">Google Recaptcha</h2>
//                                     <Info className="h-5 w-5 text-gray-400" />
//                                 </div>
//                                 {openSections.googleRecaptcha ? <ChevronUp className="h-5 w-5" /> : <ChevronDown className="h-5 w-5" />}
//                             </CollapsibleTrigger>
//                             <CollapsibleContent className="px-6 pb-6">
//                                 <div className="space-y-4">
...
//                             <CollapsibleContent className="px-6 pb-6">
//                                 <div className="space-y-4">
//                                     <p className="text-gray-600">Set limits for your referral program.</p>
//                                 </div>
//                             </CollapsibleContent>
//                         </Collapsible>
...
//                             <CollapsibleContent className="px-6 pb-6">
//                                 <div className="space-y-4">
//                                     <p className="text-gray-600">Configure SEO meta tags for your referral pages.</p>
//                                 </div>
//                             </CollapsibleContent>
//                         </Collapsible>
...
//                             <CollapsibleTrigger className="flex items-center justify-between w-full p-6">
//                                 <div className="flex items-center gap-2">
//                                     <h2 className="text-lg font-medium">User Behavior</h2>
//                                 </div>
//                                 {openSections.userBehavior ? <ChevronUp className="h-5 w-5" /> : <ChevronDown className="h-5 w-5" />}
//                             </CollapsibleTrigger>
//                             <CollapsibleContent className="px-6 pb-6">
//                                 <div className="space-y-4">
...
//                             <CollapsibleContent className="px-6 pb-6">
//                                 <div className="space-y-4">
//                                     <p className="text-gray-600">Set default text to display when your campaign is paused.</p>
//                                 </div>
//                             </CollapsibleContent>
//                         </Collapsible>
...
//                             <CollapsibleTrigger className="flex items-center justify-between w-full p-6">
//                                 <div className="flex items-center gap-2">
//                                     <h2 className="text-lg font-medium">User Verification</h2>
//                                     <Info className="h-5 w-5 text-gray-400" />
//                                 </div>
//                                 {openSections.userVerification ? <ChevronUp className="h-5 w-5" /> : <ChevronDown className="h-5 w-5" />}
//                             </CollapsibleTrigger>
//                             <CollapsibleContent className="px-6 pb-6">
//                                 <div className="space-y-4">
...
//                             <CollapsibleContent className="px-6 pb-6">
//                                 <div className="space-y-4">
//                                     <p className="text-gray-600">Upload and configure the favicon for your campaign pages.</p>
//                                 </div>
//                             </CollapsibleContent>
//                         </Collapsible>
...
//                             <CollapsibleContent className="px-6 pb-6">
//                                 <div className="space-y-4">
//                                     <p className="text-gray-600">Configure terms and conditions for your referral program.</p>
//                                 </div>
//                             </CollapsibleContent>
//                         </Collapsible>
...
//                             <CollapsibleContent className="px-6 pb-6">
//                                 <div className="space-y-4">
//                                     <p className="text-gray-600">Configure privacy policy for your referral program.</p>
//                                 </div>
//                             </CollapsibleContent>
//                         </Collapsible>
...
//                         <Button
//                             variant="outline"
//                             className="w-full py-6 flex items-center justify-center gap-2 bg-white"
